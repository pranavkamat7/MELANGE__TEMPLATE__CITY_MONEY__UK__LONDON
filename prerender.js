...
function startServer(distPath, port) {
  return new Promise((resolve) => {
    const server = createServer((req, res) => {
      // Strip the /uk/digital-marketing-agency-london base path for file lookup
      let urlPath = req.url.replace(/^\/uk\/digital-marketing-agency-london\//, "") || "/";
...
for (const route of routes) {
  try {
    ...
    // Save to dist/uk/digital-marketing-agency-london/index.html
